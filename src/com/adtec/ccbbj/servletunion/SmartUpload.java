...
public class SmartUpload {
	...
	public String[] getFileNames() {
		...
		String[] vFileNames = new String[0];
		if (FileNames != null && FileNames.length > 0) {

			vFileNames = new String[FileNames.length];
	...
	//  modify by zhangyechi at 20080221 原因:去处下载乱码的问题
	...
	/*
	 ...
	 //System.out.println("abyte0："+new String(abyte0));
	...
	//  modify by zhangyechi at 20080221 原因:去处下载乱码的问题 end
	//*******************************************************************
	public void downloadFile(String s, String s1, String s2, int i)
			throws ServletException, IOException, SmartUploadException {
		if (s == null)
	...
	public void downloadField(ResultSet resultset, String s, String s1,
		...
		if (s1 == null) {
			m_response.setContentType("application/x-msdownload");
			//m_response.setContentType("x-msdownload");
		} else {
			if (s1.length() == 0) {
				m_response.setContentType("application/x-msdownload");
			} else {
		...
		if (s2 == null) {
			...
			//m_response.setHeader("Content-Disposition", "attachment;filename=snapshot.pdf");
		} else {
			if (s2.length() == 0) {
				m_response.setHeader("Content-Disposition", "attachment;");
			} else {
