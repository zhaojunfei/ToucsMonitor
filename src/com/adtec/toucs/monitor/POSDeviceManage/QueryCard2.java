...
public class QueryCard2 {
   ...
   */
	public QueryCard2(String inTrack_no,String inMatchStart,String inCardMatch,String inBankCode,String inRec_datetime,String inRec_useflag) {
		track_no=inTrack_no;
   ...
   */
	public List query(Connection conn) throws MonitorException{
		String strSql="SELECT * FROM pos_lc_card ";
		String strW="";
...
//			if(bankCode.trim().length()!=0) tmpList.add(" bankCode='"+bankCode+"'");
		...
		try{
			...
			while(rst.next()){
				POSLcCardInfo cardTypeStruct=new POSLcCardInfo();
