...
public class POSInAccountInfo {
	...
	public void fetchData(ResultSet rst) throws SQLException {
	   ...
	   * @throws SQLException
	   */
	  public PreparedStatement makeUpdateStm(Connection conn) throws
	      SQLException, MonitorException {
		  String sql = "UPDATE t_para_config SET para_val =? ,pre_val =? ,pre_date =? ,pre_time =? WHERE para_name ='p_lc_acct'";	
	      Debug.println(sql);
	      Util util = new Util();
	  ...
	  public PreparedStatement makeInsertStm(Connection conn) throws SQLException, MonitorException, UnsupportedEncodingException {
		  Util util = new Util();
		  String str1 = "para_val手续费内部账户,pre_val清算内部账户";
		  str1 = new String(str1.trim().getBytes("GBK"),"ISO-8859-1");
		  String str2 = "内部账户";
