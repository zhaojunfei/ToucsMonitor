...
public class POSPoundageInfo {
	...
	public void fetchData(ResultSet rst) throws SQLException {
	  ...
	  public PreparedStatement makeUpdateStm(Connection conn) throws SQLException, MonitorException {
		  String sql = "UPDATE t_para_config SET para_val =? , pre_val = ? ,pre_date =? ,pre_time =? WHERE para_name = 'p_lc_fee'";		
		  Debug.println(sql);
		  Util util = new Util();
