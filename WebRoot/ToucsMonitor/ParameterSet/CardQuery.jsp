...
<%
	...
	if(obj1!=null)reqCode=(String)obj1;
  	...
  	String hasM="",hasQ="";
   	//System.out.println("opv=================="+opv);
  	if(opv !=null){
   	//System.out.println("opv not null");
	Object obj2;	
...
function check(){     
	...
	//if(TextIsNull("cardMatch",15))		return false;	
	//if(TextIsNull("bankCode",4)) return false;	
	return true;
}
...
function submit11(type){				
	...
	var url;
	url="/ToucsMonitor/parametersetservlet?reqCode=<%=reqCode%>";				
	document.form1.action=url;	
	document.form1.submit();
} 
</script>
	...
	<table width="49%" border="0">
    	...
    	<tr> 
      		...
      		<td width="68%"> 
	        	...
	        	<input type="radio" name="rec_useflag"  class="radio" value="3">所有 
	        </td>
    	</tr>
  	</table>
<hr noshade>
