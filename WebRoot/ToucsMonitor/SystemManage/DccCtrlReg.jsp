...
%>
<form name="formReg" method="post" action="/ToucsMonitor/dccctrl?reqCode=17801&uid=<%=uid%>" onSubmit="javascript:return doSubmit();">
<font face="隶书" size="+2">控制信息新增</font>
	<table id="tab0" width="90%" height="271">
		...
		<tr>
			...
			<td width="33%" nowrap>
				<select name="channel_id" size="1">
					...
					<%
						initList("ChannelId", "", request, out);
					%>
				</select>*
			</td>
		</tr>
		<tr>
			...
			<td width="33%" nowrap>
				<select name="service" size="1">
					<option value="">请选择</option>
					<%
						initList("ServiceKind", "", request, out);
					%>
				</select>*
			</td>
		</tr>
		<tr>
			...
			<td width="33%" nowrap height="19">
				<input type="text" name="trans_amt" class="wideinput" value="" maxlength="15" size="15">
			</td>
		</tr>
		<tr>
			<td width="20%" nowrap height="19" align="right">累计限额：</td>
			<td width="60%" nowrap height="19">
				<input type="text" name="total_amt" class="wideinput" value="" maxlength="15" size="15">
			</td>
		</tr>
		<tr>
			...
			<td colspan="5" nowrap>
				<div align="right">
					...
					<input type="button" name="cancelbutton" value="取消" class="inputbutton"
						onClick="javascript:location.href='/ToucsMonitor/ToucsMonitor/SystemManage/DccCtrlManage.jsp'">
				</div>
			</td>
		</tr>
	</table>
