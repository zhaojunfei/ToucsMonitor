...
<!--form name="formQuery" method="post" action="/ToucsMonitor/devicemanage?reqCode=<%=request.getParameter("post")%>" -->
<%
...
%>
  	<table width="100%" cellspacing="0">
  		...
  		<tr> 
    		<td> 
				<input type="button" name="add" value="添加" class="inputbutton" onClick=javascript:location.href='/ToucsMonitor/deviceconfig?reqCode=13001&uid=<%=uid%>' <%=canAdd?"":"DISABLED"%> >
      			<input type="button" name="add2" value="修改" class="inputbutton" onClick=javascript:location.href='/ToucsMonitor/deviceconfig?reqCode=13002&uid=<%=uid%>' <%=canModify?"":"DISABLED"%> >
      			<input type="button" name="query" value="查询" class="inputbutton" onClick=javascript:location.href='/ToucsMonitor/deviceconfig?reqCode=13003&uid=<%=uid%>' <%=canQuery?"":"DISABLED"%> >
			</td>
  		</tr>
  		<tr> 
    		<td height="10"> 
  		...
  		<tr> 
    		<td height="20"> 
      			<div align="center"> 
        		<jsp:include page="/DeviceManage/AtmList.jsp" flush="true"/>
      			</div>
    		</td>
  		</tr>
  		<tr> 
