...
%>
<form name="formQuery" method="post" action="/ToucsMonitor/thirdPartyTeller?reqCode=13204&uid=<%=uid%>" onSubmit="javascript:return doSubmit();">
<font face="隶书" size="+2">第三方柜员查询</font>
