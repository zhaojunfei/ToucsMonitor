...
%>
<form name="formQuery" method="post" action="/ToucsMonitor/thirdPartyMerchant?reqCode=13404&uid=<%=uid%>" >
<font face="隶书" size="+2">支付平台商户查询</font>
	<table width="80%"   cellpadding="0" cellspacing="0">
    	...
    	<tr>
      		<td colspan="4">
        	<div align="right">
        		<input type="submit" name="Submit32" value="确定" class="inputbutton" onClick = "return doSubmit()">
        	</div>
      		</td>
    	</tr>
	</table>
