...
<form name="formQuery" method="post" action="/ToucsMonitor/poscompany?reqCode=16509&uid=<%=uid%>" onSubmit="javascript:return doSubmit();">
<font face="隶书" size="+2">商业IC卡公司交易明细查询</font>
