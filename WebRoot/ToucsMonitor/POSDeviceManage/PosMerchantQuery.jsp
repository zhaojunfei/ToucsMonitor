...
<h2><font face="隶书">商户信息查询</font></h2>
<form name="formQuery" method="post" action="/ToucsMonitor/posmerchantconfig?reqCode=10404&uid=<%=uid%>" onSubmit="javascript:return doSubmit()">
    ...
    <tr>
      <td colspan="4">
        <table width="668" height="24">
          <tr>
            <td width="106" height="19">POS商户编号：</td>
            <td width="386" height="19">
              <input type="text" name="merchant_id" value="" maxlength="15">
            </td>
          </tr>
        </table>
      </td>
      ...
      <td colspan="4" width="662" >
        ...
        <a href="javascript:document.formQuery.submit()">[加载]</a-->
          ...
          <tr>
           ...
           <td  height="44"><input type=text size=20 MAXLENGTH=40 name="merchant_name" >(支持模糊查询)</td>
          </tr>
		  <tr>
           <td width="24%" height="44" align="right">是否允许预付费卡：</td>
           <td  height="44">
