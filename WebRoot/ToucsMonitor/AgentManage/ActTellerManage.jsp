...
%>
<form name="formQuery" method="post" action="/ToucsMonitor/actteller?reqCode=17604&uid=<%=uid%>" onSubmit="javascript:return doSubmit();">
<font face="隶书" size="+2">代理柜员查询</font>
