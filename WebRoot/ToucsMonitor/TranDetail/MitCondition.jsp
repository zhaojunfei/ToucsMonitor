...
<script>
function CHK(){
	var mitcode = document.form1.mitcode.value;
    if(mitcode ==""){
    	alert("请输入MIT编号！");
      	document.form1.mitcode.focus();
      	return false;
    }
    return true;
  }
...
<form name="form1" method="post" action="/ToucsMonitor/TranDetailQuery" onsubmit="return CHK();">
	<table width="75%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr> 
      		<td width="20%" height="30"><font size="2">MIT设备编号：</font></td>
      		<td width="73%" height="30"> 
        		<input type="text" name="mitcode" value="" size="15">
        		<input type="hidden" name="reqCode" value="18301">
      		</td>
    	</tr>
    	<tr> 
      		<td colspan="2" height="30"> 
