...
%>
<form name="formReg" method="post" action="/ToucsMonitor/bfteller?reqCode=17921&uid=<%=uid%>" onSubmit="javascript:return doSubmit();">
	...
	<table id="tab0" width="90%" height="271">
		...
		<tr>
			...
			<td width="30%" nowrap height="19">
				<input type="text" name="op_no" class="wideinput" value="" maxlength="20" size="20">*
			</td>
		...
		<tr>
			...
			<td width="30%" nowrap height="19">
				<input type="text" name="dcc_term_type" class="wideinput" value="" maxlength="1" size="1">
			</td>
		</tr>
		<tr>
			<td width="20%" nowrap height="19" align="right">DCC终端序号：</td>
			<td width="30%" nowrap height="19">
				<input type="text" name="dcc_term_srl" class="wideinput" value="" maxlength="3" size="3">
			</td>
			<td width="30%" nowrap>
