...
%>
<form name="formReg" method="post" action="/ToucsMonitor/bffc?reqCode=17903&uid=<%=uid%>" onSubmit="javascript:return doSubmit();">
<font face="隶书" size="+2">烟草公司修改</font>
	<table id="tab0" width="90%" height="271">
		...
		<tr>
			...
			<td width="30%" nowrap height="19">
				<input type="text" name="brief" class="wideinput" value="<%=Info.getBrief()%>" maxlength="20" size="20">*
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="30%" nowrap height="19">
				<input type="text" name="ip_addr" class="wideinput" value="<%=Info.getIp_addr()%>" maxlength="16" size="16">
			</td>
		</tr>
		<tr>
			<td width="20%" nowrap height="19" align="right">联系人：</td>
			<td width="30%" nowrap height="19">
				<input type="text" name="contractor" class="wideinput" value="<%=Info.getContractor()%>" maxlength="30" size="30">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="60%" nowrap height="19">
				<input type="text" name="bank_acc_no" class="wideinput" value="<%=Info.getBank_acc_no()%>" maxlength="30" size="30">*
			</td>
		</tr>
		<tr>
			<td width="20%" nowrap height="19" align="right">商户号：</td>
			<td width="30%" nowrap height="19">
				<input type="text" name="merchant_id" class="wideinput" value="<%=Info.getMerchant_id()%>" maxlength="30" size="30">
			</td>
		...
		<tr>
			...
			<td width="30%" nowrap height="19">
				<input type="text" name="min_sum_of_tran" class="wideinput" value="<%=Info.getMin_sum_of_tran()%>" maxlength="10" size="10">*
			</td>
			<td width="20%" nowrap height="19" align="right">最大金额：</td>
			<td width="30%" nowrap height="19">
				<input type="text" name="max_sum_of_tran" class="wideinput" value="<%=Info.getMax_sum_of_tran()%>" maxlength="10"size="10">*
			</td>
		</tr>
		<tr>
			<td width="20%" nowrap height="19" align="right">起始日期：</td>
			<td width="30%" nowrap height="19">
				<input type="text" name="start_date" class="wideinput" value="<%=Info.getStart_date()%>" maxlength="8" size="8">
			</td>
			<td width="20%" nowrap height="19" align="right">终止日期：</td>
			<td width="30%" nowrap height="19">
				<input type="text" name="end_date" class="wideinput" value="<%=Info.getEnd_date()%>" maxlength="8" size="8">
			</td>
		</tr>
		<tr>
